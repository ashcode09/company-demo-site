<?php query_posts('&tag=""&cat='.$catid); while (have_posts()) : the_post(); if (function_exists('the_content_part')) the_content_part(1); endwhile; wp_reset_query();?>
  ...
  <div id="toolkitBgImage" class="toolkit-bg-image bg-img-parallax" style="background-image: url(<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/wp-content/themes/bcsg-demo-theme/img/blue-jagged-bg.jpg' ?>)">
    <div class="container">
      <h2 class="text-uppercase">
        ...
        <?php query_posts('&tag="toolkitmainheading"&cat='.$catid); while (have_posts()) : the_post(); the_content(); endwhile; wp_reset_query();?>
        <div class="heading-underline"></div>
      </h2>
      <div class="intro-copy"><?php query_posts('&tag="toolkitintroduction"&cat='.$catid); while (have_posts()) : the_post(); the_content(); endwhile; wp_reset_query();?></div>
      <div class="row">
        ...
        <div class="col-sm-6 col-md-3" onmouseover="showHoverBox(this)" onmouseleave="hideHoverBox(this)">
          ...
          <div class="hover-boxes" style="background-image: linear-gradient(rgba(34, 44, 52, 0.8), rgba(34, 44, 52, 0.8)), url(<?php bloginfo('template_directory'); ?>/img/planhq-1.jpg)">
            <?php query_posts('&tag="toolkitplanhq"&cat='.$catid); while (have_posts()) : the_post(); ?>
              <h4 class="headings"><?php the_title(); ?></h4>
              <div class="content"><?php the_content(); ?></div>
            <?php endwhile; wp_reset_query();?>
            <div class="deal text-uppercase">Free</div>
        ...
        <div class="col-sm-6 col-md-3" onmouseover="showHoverBox(this)" onmouseleave="hideHoverBox(this)">
          ...
          <div class="hover-boxes" style="background-image: linear-gradient(rgba(34, 44, 52, 0.8), rgba(34, 44, 52, 0.8)), url(<?php bloginfo('template_directory'); ?>/img/receipt-bank.jpg)">
            <?php query_posts('&tag="toolkitreceiptbank"&cat='.$catid); while (have_posts()) : the_post(); ?>
              <h4 class="headings"><?php the_title(); ?></h4>
              <div class="content"><?php the_content(); ?></div>
            <?php endwhile; wp_reset_query();?>
            <div class="deal text-uppercase">£6</div>
        ...
        <div class="col-sm-6 col-md-3" onmouseover="showHoverBox(this)" onmouseleave="hideHoverBox(this)">
          ...
          <div class="hover-boxes" style="background-image: linear-gradient(rgba(34, 44, 52, 0.8), rgba(34, 44, 52, 0.8)), url(<?php bloginfo('template_directory'); ?>/img/sage.jpg)">
            <?php query_posts('&tag="toolkitsagebundle"&cat='.$catid); while (have_posts()) : the_post(); ?>
              <h4 class="headings"><?php the_title(); ?></h4>
              <div class="content"><?php the_content(); ?></div>
            <?php endwhile; wp_reset_query();?>
            <div class="deal text-uppercase">£12</div>
        ...
        <div class="col-sm-6 col-md-3" onmouseover="showHoverBox(this)" onmouseleave="hideHoverBox(this)">
          ...
          <div class="hover-boxes" style="background-image: linear-gradient(rgba(34, 44, 52, 0.8), rgba(34, 44, 52, 0.8)), url(<?php bloginfo('template_directory'); ?>/img/be-online.jpg)">
            <?php query_posts('&tag="toolkitbonline"&cat='.$catid); while (have_posts()) : the_post(); ?>
              <h4 class="headings"><?php the_title(); ?></h4>
              <div class="content"><?php the_content(); ?></div>
            <?php endwhile; wp_reset_query();?>
            <div class="deal text-uppercase">£15</div>
